...
const AppLayout = () => {
  ...
  // bottom dock order (reverted to 2 tabs — see FloatingDock.tsx). Direction
  // is tracked so the page transition can slide the correct way for BOTH
  // swipe and tap navigation, not just an instant cut.

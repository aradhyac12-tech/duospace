...
import { Fingerprint, Bell, Vibrate, EyeOff, Scan, Smile, KeyRound } from "lucide-react";
        ...
        <div className="bg-card rounded-2xl border border-border/60 divide-y divide-border/40">
          ...
          {appSettings.peekGuard && (
            <div className="flex items-center gap-3 px-4 py-3">
              ...
              <button onClick={() => { hapticLight(); setShowPeekConfig(true); }} className="h-7 px-3 rounded-full bg-muted text-[11px] text-foreground">Configure</button>
            </div>
          )}
          {appSettings.moodDetection && (
            <div className="flex items-center gap-3 px-4 py-3">
              ...
              <button onClick={() => { hapticLight(); setShowMoodHistory(true); }} className="h-7 px-3 rounded-full bg-muted text-[11px] text-foreground">View</button>
            </div>
          )}
        </div>
      </div>

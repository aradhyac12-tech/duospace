        ...
        <DialogContent className="rounded-2xl max-w-[360px]">
          ...
          {showInviteQr && (
            <QRSignInDisplay
              ...
              onRedeemed={(kind) => {
                if (kind === "partner_linked") toast({ title: "Linked ✓", description: "You're now partners." });
                else toast({ title: "Scanned ✓", description: "They're finishing signup on their device." });
              }}
            />
          )}
        </DialogContent>

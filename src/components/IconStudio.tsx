        ...
        {view === "customize" && (
          <div className="space-y-5 pt-1">
                ...
                <div className="bg-card rounded-2xl border border-border/60 p-4 space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex rounded-full border border-border/60 overflow-hidden">
                      <button onClick={() => { setCfg(c => ({ ...c, useLetter: false })); }} className={cn("h-7 px-3 text-[11px] font-medium flex items-center gap-1", !cfg.useLetter ? "bg-primary text-primary-foreground" : "text-muted-foreground")}>
                        <ImageIcon className="h-3 w-3" /> Symbol
                      </button>
                      <button onClick={() => { setCfg(c => ({ ...c, useLetter: true })); }} className={cn("h-7 px-3 text-[11px] font-medium flex items-center gap-1", cfg.useLetter ? "bg-primary text-primary-foreground" : "text-muted-foreground")}>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex rounded-full border border-border/60 overflow-hidden">
                      {(["solid", "gradient"] as IconBgType[]).map(t => (
                        <button key={t} onClick={() => { setCfg(c => ({ ...c, bgType: t })); }} className={cn("h-7 px-3 text-[11px] font-medium capitalize", cfg.bgType === t ? "bg-primary text-primary-foreground" : "text-muted-foreground")}>{t}</button>
                      ))}
                    </div>
                  </div>
            ...
            <div className="flex gap-2 pb-1">
              <Button variant="outline" onClick={() => { setView("gallery"); }} className="rounded-xl flex-1 h-10 text-xs">Back to presets</Button>

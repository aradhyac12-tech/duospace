...
// Bump alongside package.json "version", or wire to a build-time define later.
export const APP_VERSION = (import.meta.env.VITE_APP_VERSION as string | undefined) ?? "3.2.0";

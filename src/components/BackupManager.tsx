...
import { firmSpring } from "@/lib/motion";
import { hapticMedium, hapticHeavy, hapticSelection, hapticWarning, hapticSuccess } from "@/lib/haptics";
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div initial={{ scale: 0.92 }} animate={{ scale: 1 }} exit={{ scale: 0.92 }}
              ...
              <div className="flex gap-2">
                <button onClick={() => { setConfirmRestore(null); setIsNewDevice(false); setManualKeyInput(""); }} className="flex-1 h-10 rounded-xl border border-border text-sm">Cancel</button>
                <button
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div initial={{ scale: 0.92 }} animate={{ scale: 1 }} exit={{ scale: 0.92 }}
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <button onClick={() => { setShowSecret(false); }} aria-label="Close" className="h-9 w-9 rounded-full flex items-center justify-center active:bg-muted">

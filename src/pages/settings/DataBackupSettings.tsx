...
import OfflineStorageCard from "@/components/settings/OfflineStorageCard";

/**
 * Data & Backup: cloud sync status + the BackupManager (backup now, restore
 * from cloud, manual export/import, encryption key) + the call engine call key
...
const DataBackupSettings = () => (
  ...
  >
    <PageHeader title="Data & Backup" subtitle="Offline storage, backups, and call encryption keys" />

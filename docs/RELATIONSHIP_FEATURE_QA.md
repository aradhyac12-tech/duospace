...
| Navigation back | ✅ | `PageHeader`, unchanged. |
| Deep link | 🆕 | Songs now push to the partner (`song_added`, 2026-09-23 — see `20260923100000_playlist_song_added_push_notification.sql`) and tapping the notification opens `/playlist`. Previously flagged here as missing ("no push type exists for 'song added'"). |
| Mobile scrolling | ✅ | Unchanged. |

 ...
 * Daily.co's own open be the only one. Native and browsers where the
 * Permissions API doesn't cover microphone (Safari) fall through to the
 * original full probe unchanged, since there's no reliable non-probing
 * signal to trust there.
 */

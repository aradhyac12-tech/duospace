...
object TelecomHelper {
    ...
    fun registerIncomingCall(
        ...
        return try {
            ...
            val callDataExtras = Bundle().apply {
                for ((k, v) in decline) if (v != null) putString(DuoSpaceConnection.EXTRA_DECLINE_PREFIX + k, v)
     ...
     * action (DuoSpace's outgoing-call flow starts the call engine room
     * directly from JS via the call engine adapter and doesn't need Telecom to

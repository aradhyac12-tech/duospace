  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-6">
      ...
      >
        ...
        {step === 2 && (
          <button
            onClick={() => { hapticLight(); handleNext(""); }}
            disabled={saving}
        ...
        {step === 3 && isFemale && (
          <button
            onClick={() => { hapticLight(); setLastPeriodDate(""); handleNext(); }}
            disabled={saving}
            className="w-full text-center text-xs text-muted-foreground underline underline-offset-2"
          >
            Skip for now
        ...
        {step > 0 && (
          <button onClick={() => { hapticLight(); setStep(step - 1); }} className="w-full text-center text-xs text-muted-foreground">
            Go back
          </button>
        )}
      </motion.div>

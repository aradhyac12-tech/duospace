...
export const CallProvider = ({ children }: { children: ReactNode }) => {
  ...
  const value: CallContextValue = { ...call, activeCallId, setActiveCallId, isAcceptingCall, cancelAcceptingCall, activeCallType, setActiveCallType, isCallMinimized, setIsCallMinimized };

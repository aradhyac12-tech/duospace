import { Image, MapPin, Music, Heart, BookOpen, Compass, type LucideIcon } from "lucide-react";
...
export const DUO_HUB_ITEMS: DuoHubItem[] = [
  ...
  { path: "/reflection", icon: Compass, label: "Reflection", description: "A private space to reflect on values, expectations, and how you communicate", tier: "more" },
];

        ...
        <div className="flex items-center gap-1">
          {hasText && (
            <>
              ...
              <button onClick={() => { handleClear(); }} aria-label="Clear transcript"
                className="h-8 w-8 rounded-full bg-white/10 flex items-center justify-center active:bg-white/20">
          ...
          >
            ...
            <div className="px-4 pb-3">
              <p className="text-[9px] text-white/20 leading-tight">
                Reads your <strong className="text-white/30">partner's</strong> mouth shape via their video feed —
                a best-effort guess from a small phrase list, not a real transcript. Words that look alike
                (bilabial p/b/m / प/ब/म, or homophones in general) can be mixed up.
              </p>
            </div>
          </motion.div>
        )}

          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div initial={{ scale: 0.92 }} animate={{ scale: 1 }} exit={{ scale: 0.92 }}
              ...
              <div className="flex gap-2">
                <button onClick={() => { hapticLight(); setConfirmRestore(null); }} className="flex-1 h-10 rounded-xl border border-border text-sm">Cancel</button>
                <button onClick={() => { hapticHeavy(); handleRestore(confirmRestore); }} className="flex-1 h-10 rounded-xl bg-primary text-primary-foreground text-sm font-medium">Restore</button>
              </div>
            </motion.div>
          </motion.div>
        )}

...
// Browser-only mocks. Skipped for tests that opt into `@vitest-environment node`
// (e.g. signalingTicketAuthz.test.ts, which exercises Node server code).
...
if (HAS_DOM) {
  ...
  Object.defineProperty(navigator, "onLine", {
    writable: true,
    configurable: true, // connectivity.test.ts redefines it per case
    value: true,
  });
}

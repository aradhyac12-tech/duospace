...
import { ChevronRight, Settings as SettingsIcon, Heart, Link2 } from "lucide-react";
...
/**
 * Profile — identity, not settings. Avatar, partner name, connection status,
 * and a one-line relationship overview. Everything else (theme, privacy,
 * notifications, haptics, account) stays behind the single "Settings" row,
 * so this screen never grows into a second settings page. Feature-hub
 * items (Gallery, Music, Map, Shayari, Love Letter, Memories, ...) live in
 * their own hub and are deliberately not duplicated here.
 */
const Profile = () => {
    ...
    <div className="flex flex-col h-full overflow-y-auto">
      ...
      <div className="flex flex-col items-center px-6 pt-6 pb-8">
        ...
        <h1 className="text-lg font-semibold text-foreground mt-4">
          {partnerLinked ? partnerName || "Partner" : "No partner linked yet"}
        </h1>

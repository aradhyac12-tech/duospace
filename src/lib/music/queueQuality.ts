...
const NOISE_RE = /[\(\[][^)\]]*(official|video|audio|lyric|lyrics|hd|hq|4k|visualizer|mv|explicit|clean|remaster(ed)?|remix(ed)?|cover|live|acoustic|version|edit|extended|slowed|reverb|sped up)[^)\]]*[\)\]]/gi;

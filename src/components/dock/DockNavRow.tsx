...
// PERF/BUG FIX ("hub fluttering"): badge counts now come from a context
// provider mounted once at AppLayout (see DockBadgesContext.tsx for why) —
// not a hook that re-subscribes every time this row's parent (FloatingDock
// vs DuoSpaceBottomSurface) unmounts/remounts across a route swap.
import { useDockBadges } from "@/contexts/DockBadgesContext";

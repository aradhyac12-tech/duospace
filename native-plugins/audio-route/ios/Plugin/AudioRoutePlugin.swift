...
/// The call engine's WebRTC engine already configures the session (playAndRecord,
...
/// The call engine call is actually joined. Calling it outside a call just throws

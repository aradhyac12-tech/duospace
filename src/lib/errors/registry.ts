...
export const ERROR_REGISTRY: Record<string, ErrorDefinition> = {
  ...
  // ── Us & Memories ──────────────────────────────────────────────────────
  "DS-US-001": {
    code: "DS-US-001", category: "Us & Memories", severity: "ERROR",
    title: "Couldn't load your world",
    message: "Profile, countdowns, or today's question couldn't be fetched.",
    recoverySuggestion: "Check your connection and try again.",
    retryable: true, recoveryAction: "retry-supabase",
  },
  "DS-US-002": {
    code: "DS-US-002", category: "Us & Memories", severity: "WARNING",
    title: "Couldn't save countdown",
    message: "The countdown you added didn't save.",
    recoverySuggestion: "Try adding it again.",
    retryable: true, recoveryAction: "retry-supabase",
  },
  "DS-US-003": {
    code: "DS-US-003", category: "Us & Memories", severity: "WARNING",
    title: "Tap didn't send",
    message: "Your \"thinking of you\" tap couldn't be delivered.",
    recoverySuggestion: "Try sending it again.",
    retryable: true, recoveryAction: "retry-network",
  },
  "DS-US-004": {
    code: "DS-US-004", category: "Us & Memories", severity: "WARNING",
    title: "Answer didn't save",
    message: "Today's question answer couldn't be submitted.",
    recoverySuggestion: "Try submitting it again.",
    retryable: true, recoveryAction: "retry-supabase",
  },
  "DS-US-005": {
    code: "DS-US-005", category: "Us & Memories", severity: "ERROR",
    title: "Couldn't load memories",
    message: "The memory wall couldn't be fetched.",
    recoverySuggestion: "Check your connection and try again.",
    retryable: true, recoveryAction: "retry-supabase",
  },
  "DS-US-006": {
    code: "DS-US-006", category: "Us & Memories", severity: "ERROR",
    title: "Memory didn't save",
    message: "This memory (photo or note) couldn't be uploaded.",
    recoverySuggestion: "Check your connection and try again.",
    retryable: true, recoveryAction: "retry-network",
  },
  ...
  // ── Mood ──────────────────────────────────────────────────────────────
  "DS-MOOD-001": {
    code: "DS-MOOD-001", category: "Mood", severity: "WARNING",
    title: "Mood didn't save",
    message: "Your mood update couldn't be written.",
    recoverySuggestion: "Try setting it again.",
    retryable: true, recoveryAction: "retry-supabase",
  },
  "DS-MOOD-002": {
    code: "DS-MOOD-002", category: "Mood", severity: "WARNING",
    title: "Mood history unavailable",
    message: "Your mood check-ins couldn't be loaded right now.",
    recoverySuggestion: "Check your connection and try again.",
    retryable: true, recoveryAction: "retry-supabase",
  },
  ...
  // ── Map ───────────────────────────────────────────────────────────────
  "DS-MAP-001": {
    code: "DS-MAP-001", category: "Map", severity: "ERROR",
    title: "Location access required",
    message: "DuoSpace doesn't have permission to read this device's location.",
    recoverySuggestion: "Enable location access in your device settings.",
    retryable: true, recoveryAction: "none",
  },
  "DS-MAP-002": {
    code: "DS-MAP-002", category: "Map", severity: "WARNING",
    title: "GPS unavailable",
    message: "This device couldn't get a location fix.",
    recoverySuggestion: "Move to an area with a clearer sky view and try again.",
    retryable: true, recoveryAction: "retry-network",
  },
  "DS-MAP-003": {
    code: "DS-MAP-003", category: "Map", severity: "WARNING",
    title: "Map tiles unavailable",
    message: "The map's imagery provider didn't respond, so DuoSpace switched to a backup source.",
    recoverySuggestion: "The map should keep working; switch styles again if tiles still look wrong.",
    retryable: true, recoveryAction: "none",
  },

  // ── Shayari ───────────────────────────────────────────────────────────
  "DS-SHAYARI-001": {
    code: "DS-SHAYARI-001", category: "Shayari", severity: "ERROR",
    title: "Couldn't load shayaris",
    message: "Your shared shayaris couldn't be fetched.",
    recoverySuggestion: "Check your connection and try again.",
    retryable: true, recoveryAction: "retry-supabase",
  },
  "DS-SHAYARI-002": {
    code: "DS-SHAYARI-002", category: "Shayari", severity: "WARNING",
    title: "Shayari didn't save",
    message: "What you wrote couldn't be posted.",
    recoverySuggestion: "Try posting it again.",
    retryable: true, recoveryAction: "retry-supabase",
  },
  "DS-SHAYARI-006": {
    code: "DS-SHAYARI-006", category: "Shayari", severity: "WARNING",
    title: "Changes didn't save",
    message: "Your edit to this shayari couldn't be saved.",
    recoverySuggestion: "Your text is still in the editor — try saving again.",
    retryable: true, recoveryAction: "retry-supabase",
  },

  // ── Groic & Playlist ──────────────────────────────────────────────────
  "DS-GROIC-001": {
    code: "DS-GROIC-001", category: "Groic & Playlist", severity: "WARNING",
    title: "Search is limited right now",
    message: "The music search service and its fallbacks were unreachable.",
    recoverySuggestion: "Showing a small curated set instead — try again shortly for full results.",
    retryable: true, recoveryAction: "retry-network",
  },
  "DS-GROIC-002": {
    code: "DS-GROIC-002", category: "Groic & Playlist", severity: "ERROR",
    title: "Couldn't load your playlist",
    message: "Your shared playlist couldn't be fetched.",
    recoverySuggestion: "Check your connection and try again.",
    retryable: true, recoveryAction: "retry-supabase",
  },
  "DS-GROIC-003": {
    code: "DS-GROIC-003", category: "Groic & Playlist", severity: "WARNING",
    title: "Couldn't add song",
    message: "This song couldn't be added to the playlist.",
    recoverySuggestion: "Try adding it again.",
    retryable: true, recoveryAction: "retry-supabase",
  },
  "DS-GROIC-004": {
    code: "DS-GROIC-004", category: "Groic & Playlist", severity: "WARNING",
    title: "Blend invite failed",
    message: "The listen-together invite couldn't be sent or accepted.",
    recoverySuggestion: "Try again — make sure you're both online.",
    retryable: true, recoveryAction: "retry-network",
  },

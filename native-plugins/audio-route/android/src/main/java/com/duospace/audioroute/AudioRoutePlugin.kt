 ...
 * headset) for Android.
 *
 * IMPORTANT — this does not own the call's audio session. The call engine's WebRTC
 ...
 * must only be called while the call engine call is actually joined. Calling it

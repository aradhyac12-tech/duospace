...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      messages: {
        Row: {
          ...
          sender_id: string
          // Manually added 2026-08-24 alongside migration
          // 20260824120000_add_messages_silent_column_and_respect_in_push —
          // same situation as mood_logs.features below: the client
          // (Chat.tsx attemptSendText) has been sending `silent` via an
          // `as any` cast since the /silent command was added, but the
          // column never existed until this migration. Re-run
          // `supabase gen types` against the live project once applied.
          silent: boolean
        }
        Insert: {
          content?: string | null
      ...
      qr_pairing_tokens: {
        Row: {
          ...
          pending_partner_for: string | null
    ...
    Functions: {
      ...
      complete_qr_pending_link: { Args: { _user_id: string }; Returns: string }
      consume_rate_limit: {
        Args: {
          _bucket: string
          _max: number
      ...
      get_partner_daily_key: { Args: { _user_id: string }; Returns: string }
      get_partner_id: { Args: { _user_id: string }; Returns: string }
      get_user_id_by_email: { Args: { _email: string }; Returns: string }
      link_partners: { Args: { _a: string; _b: string }; Returns: undefined }
